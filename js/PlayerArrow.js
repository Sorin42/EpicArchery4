class PlayerArrow {
  ...
  display() {
      ...
      trajectory.push(position[position.length-2])
      trajectory.push(position[position.length-1])
  for (var i = 0;i<trajectory.length-1; i=i+2 ){
  
    
    //console.log("position"+position)
   
      ellipse(trajectory[i],trajectory[i-1],10)
      console.log("2:   "+trajectory[i]+","+trajectory[i-1])
